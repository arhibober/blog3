...
class es_cls_registerhook {
	...
	public static function es_load_widget_scripts_styles() {
		...
		$es_select_params = array(
			...
			'es_success_notice'  => _x( 'Поздравляю, Вы были успешно подписаны! Пожалуйста, проверьте Ваш почтовый ящик и подтвердите Вашу подписку. Если Вам не пришло письмо в течение нескольких минут, проверьте разделы спама и рекламы.', 'widget-page-enhanced-select', 'email-subscribers' ),
