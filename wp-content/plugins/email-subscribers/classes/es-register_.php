...
class es_cls_registerhook {
	...
	public static function es_load_widget_scripts_styles() {
		...
		$es_select_params = array(
			'es_email_notice'    => _x( 'Пожалуйста, введите Ваш email', 'widget-page-enhanced-select', 'email-subscribers' ),
			'es_rate_limit_notice' => _x( 'Пожалуйста, попробуйте позже!', 'widget-page-enhanced-select', 'email-subscribers' ),
																																																
			'es_success_message' => _x( 'Вы успешно подписаны!', 'widget-page-enhanced-select', 'email-subscribers' ),
			'es_success_notice'  => _x( 'Поздравляем, Ваш аккаунт успешно создан! Ссылка на активизацию прищшла на Ваш e-mail, возможно, в силу правил Вашего почтового ящика, она может переместится в спам', 'widget-page-enhanced-select', 'email-subscribers' ),
			'es_email_exists'    => _x( 'Email адрес уже существует!', 'widget-page-enhanced-select', 'email-subscribers' ),
			'es_error'           => _x( 'Извините! Произошла ошибка...', 'widget-page-enhanced-select', 'email-subscribers' ),
			'es_invalid_email'   => _x( 'Неправильный email', 'widget-page-enhanced-select', 'email-subscribers' ),
			'es_try_later'       => _x( 'Попытайтесь, пожалуйста, позже!', 'widget-page-enhanced-select', 'email-subscribers' ),
