...
<head>
	...
	<meta name="keywords" content="<?php
		if (is_single ())
		{
			...
			echo "Наталья Костина Кассанелли писательница блог сайт привет это я";
	?>" />
...
<body <?php body_class(); ?>>
	<div id="page" class="site">
		...
		<img src="http://localhost/blog3/wp-content/uploads/2018/09/logo60.png" class="custom-logo" alt="Блог Натальи Костиной-Кассанелли" itemprop="logo" style="position:relative; top:20px; left:50px;" >
